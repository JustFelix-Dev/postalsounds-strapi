...
export interface ApiHotspotHotspot extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    access_level: Schema.Attribute.Enumeration<['free', 'premium']>;
    audio: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    full_story: Schema.Attribute.Blocks;
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hotspot: Schema.Attribute.Relation<'oneToOne', 'api::hotspot.hotspot'>;
    images: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
